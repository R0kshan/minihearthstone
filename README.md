...
See [client](https://github.com/RoxaneKM/minihearthstone/tree/master/code/client) and [server](https://github.com/RoxaneKM/minihearthstone/tree/master/code/server) code. 
...
* [Prerequisites](https://github.com/RoxaneKM/minihearthstone#prerequisites)
* [Run the project](https://github.com/RoxaneKM/minihearthstone#run-project)
* [Run the tests](https://github.com/RoxaneKM/minihearthstone#run-the-tests)
* [Client side code documentation](https://github.com/RoxaneKM/minihearthstone/blob/master/README.md#client-side-code-documentation)
* [Server side code documentation](https://github.com/RoxaneKM/minihearthstone/blob/master/README.md#server-side-code-documentation)
* [Game functionnalities](https://github.com/RoxaneKM/minihearthstone#game-functionnalities)
* [Images, sounds, voices and music used](https://github.com/RoxaneKM/minihearthstone#images-sounds-voices-and-music-used)
* [Authors](https://github.com/RoxaneKM/minihearthstone/blob/master/README.md#authors)
...
To launch the server, go to the [/server](https://github.com/RoxaneKM/minihearthstone/tree/master/code/server) folder, and run in terminal:

* Windows: `gradle bootRun`
* Linux: `./gradlew bootRun`

To launch the client, go to the [/client](https://github.com/RoxaneKM/minihearthstone/tree/master/code/client) folder, and run in terminal :
`ng serve`.

To be able to play the game, at least two client are needed. 
To launch 2 clients, in [/client](https://github.com/RoxaneKM/minihearthstone/tree/master/code/client) folder, start in :
...
In [/client](https://github.com/RoxaneKM/minihearthstone/tree/master/code/client) folder run : `ng test --no-watch --code-coverage`

Then open the [coverage.html](https://github.com/RoxaneKM/minihearthstone/blob/master/code/client/documentation/coverage.html) in : *client/documentation/coverage*

### Run server side tests

In [/server](https://github.com/RoxaneKM/minihearthstone/tree/master/code/server) folder run :
...
See the Angular project documentation [here](https://github.com/RoxaneKM/minihearthstone/blob/master/code/client/documentation) generated by [Compodoc](https://compodoc.app/)

## Server side code documentation

See the Spring server [Javadoc](https://github.com/RoxaneKM/minihearthstone/tree/master/code/server/javadoc)
