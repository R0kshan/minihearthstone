...
public class ExplosionDesArcanesTest{

    @InjectMocks
    private ExplosionDesArcanes explo;
    ...
    private final static BasicEffect BASIC_EFFECT = new BasicEffect();
    private final static AbstractSpecificCard SPEC_CARD = new ChefDeRaid();
    ...
    /**
     * Test for the method {@link ExplosionDesArcanes#specialSkill(Long, GameBoard)}
     */
    @Test
    public void testSpecialSkill(){
        ...
        explo.specialSkill(CL1ID,gameBoard);
    ...
    public void checkPlayerAnnotations(){
        assertClassAnnotation(ExplosionDesArcanes.class, Entity.class);
    }
